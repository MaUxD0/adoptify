...
const COMMUNITY_MESSAGES = [
  {
    emoji: "🐶",
    title: "My name is Bruno.",
    text: "I spent 2 years in a shelter waiting. Every morning I'd look at the door hoping someone would come for me. One day, they did. You could be that someone for another soul like me.",
  },
  {
    emoji: "🐱",
    title: "I'm Luna.",
    text: "They found me alone in the street, scared and hungry. Now I know what warmth feels like. There are hundreds of animals still out there waiting for exactly what you can give — a home.",
  },
  {
    emoji: "🐰",
    title: "They call me Coco.",
    text: "Small animals like me are often forgotten. But we feel loneliness just as deeply. Joining this community means fighting for every life — big and small.",
  },
];
            ...
            <div className="text-center py-16">
              ...
              {searchQuery && (
                <button
                  ...
                  className="mt-3 text-pink-500 text-sm font-bold hover:underline"
                >
                  Clear search
                </button>
              )}
